      ...
      <AnimatePresence>
        {updateAvailable && (
          <motion.div
            ...
            role="status"
            aria-live="polite"
            className="fixed inset-x-4 bottom-4 z-[100] mx-auto flex max-w-sm items-center gap-3 rounded-2xl border border-white/10 bg-[#080808] px-4 py-3 shadow-2xl sm:inset-x-auto sm:right-4"
          >
            ...
            <button
              type="button"
              onClick={applyUpdate}
              className="flex items-center gap-1.5 whitespace-nowrap rounded-full bg-white px-3.5 py-2 text-xs font-bold text-black transition-transform hover:scale-[1.02] hover:bg-neutral-200 active:scale-[0.98]"
            >
