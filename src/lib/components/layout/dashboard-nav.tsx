        ...
        <div className="ml-auto flex items-center gap-2">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="gap-2 px-2 text-ink hover:bg-mauve/5 hover:text-ink">
                ...
                <div className="hidden text-left md:block">
                  <div className="text-sm font-medium text-ink">{auth.user?.full_name ?? "Account"}</div>
                  <div className="text-xs text-ink-secondary">{auth.user?.full_name ?? "Personal"}</div>
                </div>
