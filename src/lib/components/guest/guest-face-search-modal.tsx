    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl bg-neutral-900 border border-neutral-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          {!previewImage ? (
            <div className="border-2 border-dashed border-neutral-800 rounded-3xl p-8 text-center bg-neutral-950/40 hover:border-amber-500/50 transition-all flex flex-col items-center justify-center gap-4">
              <div className="w-16 h-16 rounded-full bg-neutral-800 flex items-center justify-center text-amber-400">
                <Camera className="w-8 h-8" />
              </div>
              <div className="space-y-1">
                <h3 className="text-base font-semibold text-white">Take a selfie or upload a photo</h3>
              ...
              <div className="flex gap-3 pt-2">
                <Button
                  ...
                  className="bg-gradient-to-r from-amber-500 to-rose-500 text-white hover:from-amber-600 hover:to-rose-600 rounded-xl px-5 py-2.5 font-medium flex items-center gap-2 shadow-lg shadow-amber-500/20"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 bg-neutral-950 p-4 rounded-2xl border border-neutral-800">
                <div className="relative w-16 h-16 rounded-xl overflow-hidden border border-neutral-700 flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  {isProcessing ? (
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-neutral-400">{statusMessage || "Searching..."}</p>
                    </div>
                  ) : (
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="text-sm font-semibold text-white">Search Complete</h4>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {results.map((hit) => {
                      ...
                      return (
                        <div
                          key={hit.id}
                          className="group relative aspect-square rounded-xl overflow-hidden bg-neutral-950 border border-neutral-800 hover:border-amber-500/50 transition-all"
                        >
                          <img
                            src={photoUrl}
                            alt="Matched photo"
              ...
              {!isProcessing && results.length === 0 && !error && (
                <div className="py-12 text-center text-neutral-500 space-y-2">
                  ...
                  <p className="text-sm font-medium text-neutral-400">No matching photos found yet</p>
