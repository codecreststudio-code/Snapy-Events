...
export default async function GalleryPage({ params }: PageProps<"/event/[slug]/g/[gallerySlug]">) {
  ...
  if (!ev) return <div className="min-h-screen bg-surface-dark p-8 text-center text-sm text-ink-secondary">Event not found.</div>
  ...
  if (!gallery) return <div className="min-h-screen bg-surface-dark p-8 text-center text-sm text-ink-secondary">Gallery not found.</div>
