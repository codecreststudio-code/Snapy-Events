    ...
    <main className="flex-1">
      <section className="relative overflow-hidden border-b">
        ...
        <div className="mx-auto max-w-5xl px-6 py-20 text-center">
          {event.user?.branding?.logo_url && <img src={event.user.branding.logo_url} alt={event.user.name} className="mx-auto mb-4 h-10" />}
          <p className="text-sm uppercase tracking-widest text-muted-foreground">{event.user?.name ?? "Event"}</p>
