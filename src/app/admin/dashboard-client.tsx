    ...
    <div className="bg-surface-card border border-hairline-dark rounded-2xl p-6 hover:border-mauve/30 transition-colors">
      ...
      <div className="relative h-44 flex items-end">
        ...
        <div className="absolute inset-0 flex flex-col justify-between pointer-events-none opacity-20">
          <div className="w-full border-t border-hairline-dark" />
          <div className="w-full border-t border-hairline-dark" />
          <div className="w-full border-t border-hairline-dark" />
        </div>
          ...
          {data.map((d, i) => (
            ...
            >
              {hoveredIdx === i && (
                <>
                  {/* Vertical Guide Line */}
                  <div className="absolute top-0 bottom-0 left-1/2 w-0.5 border-l border-dashed border-hairline-dark transform -translate-x-1/2 pointer-events-none" />
                  {/* Glowing Marker */}
                  <div
                    className="absolute left-1/2 w-3 h-3 rounded-full border-2 border-surface-card shadow-sm pointer-events-none transform -translate-x-1/2 -translate-y-1/2"
                    style={{
...
export default function DashboardClient() {
  ...
  return (
    <main className="px-6 py-8 space-y-8 bg-surface-dark min-h-full">
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {/* Total Revenue */}
            <Card className="bg-surface-card border-hairline-dark hover:border-mauve/30 transition-colors overflow-hidden">
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex items-center gap-1 text-[10px] font-bold">
                      <span className={cn(
                        ...
                        data.metrics?.revenue.growth >= 0 ? "text-emerald-400" : "text-red-400"
                      )}>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="mt-2 flex items-center gap-1 text-[10px] font-bold">
                      <span className={cn(
                        "flex items-center gap-0.5",
                        data.metrics?.users.growth >= 0 ? "text-emerald-400" : "text-red-400"
                      )}>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="mt-2 flex items-center gap-1 text-[10px] font-bold">
                      <span className={cn(
                        "flex items-center gap-0.5",
                        data.metrics?.events.growth >= 0 ? "text-emerald-400" : "text-red-400"
                      )}>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="mt-2 flex items-center gap-1 text-[10px] font-bold">
                      <span className={cn(
                        "flex items-center gap-0.5",
                        data.metrics?.photos.growth >= 0 ? "text-emerald-400" : "text-red-400"
                      )}>
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-1 text-[10px] font-bold">
                    <span className={cn(
                      "flex items-center gap-0.5",
                      data.metrics?.searches.growth >= 0 ? "text-emerald-400" : "text-red-400"
                    )}>
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-1 text-[10px] font-bold">
                    <span className={cn(
                      "flex items-center gap-0.5",
                      data.metrics?.storage.growth >= 0 ? "text-emerald-400" : "text-red-400"
                    )}>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card className="bg-surface-card border-hairline-dark flex flex-col justify-between">
                ...
                {data.activityFeed.length === 0 ? (
                  ...
                  data.activityFeed.map((act: any, index: number) => (
                    <div key={index} className="flex gap-3 text-xs">
                      <div className="h-6 w-6 rounded-full bg-mauve/10 flex items-center justify-center text-mauve shrink-0 border border-mauve/20">
              ...
              <div className="p-4 border-t border-hairline-dark text-center shrink-0">
                <a href="/admin/audit-logs" className="text-xs font-bold text-mauve hover:text-mauve-strong inline-flex items-center gap-1">
            ...
            <Card className="bg-surface-card border-hairline-dark flex flex-col justify-between">
              ...
              <CardContent className="p-6 grid grid-cols-2 gap-4 flex-1">
                {[
                  { label: "Database", status: "Healthy", icon: Database, color: "text-emerald-400 bg-emerald-500/10" },
                  { label: "Storage S3", status: "Healthy", icon: HardDrive, color: "text-emerald-400 bg-emerald-500/10" },
                  { label: "API Edge", status: "Healthy", icon: Activity, color: "text-emerald-400 bg-emerald-500/10" },
                  { label: "WhatsApp API", status: "Healthy", icon: Send, color: "text-emerald-400 bg-emerald-500/10" },
                  { label: "Email SMTP", status: "Healthy", icon: Mail, color: "text-emerald-400 bg-emerald-500/10" },
                  { label: "Payments Gateway", status: "Healthy", icon: CreditCard, color: "text-emerald-400 bg-emerald-500/10" },
              ...
              <div className="p-4 border-t border-hairline-dark text-center shrink-0">
                <a href="/admin/system-health" className="text-xs font-bold text-mauve hover:text-mauve-strong inline-flex items-center gap-1">
            ...
            <Card className="bg-surface-card border-hairline-dark flex flex-col justify-between">
              ...
              <div className="p-4 border-t border-hairline-dark text-center shrink-0">
                <a href="/admin/subscriptions" className="text-xs font-bold text-mauve hover:text-mauve-strong inline-flex items-center gap-1">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card className="bg-surface-card border-hairline-dark lg:col-span-2 flex flex-col justify-between">
              ...
              <div className="p-4 border-t border-hairline-dark text-center shrink-0">
                <a href="/admin/events" className="text-xs font-bold text-mauve hover:text-mauve-strong inline-flex items-center gap-1">
